...
local TargetDisplay = 'SnakeDarling' -- Target Display Name
...
local AltAccName = 'Jaco_m' -- \\ Name of your alt account in the server // friends account in the server. Has to be the exact roblox name.
